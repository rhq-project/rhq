...
/**
 * This is the classloader used by the spawned agents. This class loader can be absolutely and completely isolated from
 * any other classloader in the system except for the top-most system classloader if you pass in a null parent.
 *
 * @author John Mazzitelli
 */
public class SpawnedAgentClassLoader extends URLClassLoader {
    private final URL[] nativeLibraryUrls;

    public SpawnedAgentClassLoader(URL[] classUrls, URL[] nativeUrls, ClassLoader parent) {
        super(classUrls, (parent != null) ? parent : getTopMostClassLoader());
    ...
    protected String findLibrary(String libname) {
        ...
        for (URL nativeLibraryUrl : nativeLibraryUrls) {
            try {
                ...
                throw new IllegalArgumentException("Bad native library URL: " + nativeLibraryUrl, e);
            }
        }
