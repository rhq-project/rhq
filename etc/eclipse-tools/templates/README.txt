These are templates you import into your Eclipse IDE so it formats the code properly as per the project's coding standards.

cleanup-profile.xml : Preferences > Java Code Style > Clean Up
