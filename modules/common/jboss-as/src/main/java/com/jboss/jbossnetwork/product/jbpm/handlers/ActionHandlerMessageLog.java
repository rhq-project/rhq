...
/**
 * JBPM message log subclass that holds onto data that describes a particular step in the workflow, using the domain
...
public class ActionHandlerMessageLog extends MessageLog {
    ...
    public void setStep(DeployPackageStep step) {
        this.step = step;
    }
}