 ...
 */
package org.rhq.core.clientapi.agent.snapshot;

import java.io.InputStream;

/**
 * The interface to agent's snapshot reporting subsystem which allows the server to request a snapshot report to be
 * generated for any resource that supports snapshot reporting.
 */
