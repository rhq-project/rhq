 ...
 */
public class EmailNotifier extends AlertNotificationTemplate {
    private List<String> recipientList = new LinkedList<String>();

    public EmailNotifier addRecipient(String userName) {
    ...
    public AlertNotification getAlertNotification() {
        ...
        configuration.setSimpleValue("emailAddress", sb.toString());
