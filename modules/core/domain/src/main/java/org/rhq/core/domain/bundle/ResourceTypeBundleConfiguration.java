...
public class ResourceTypeBundleConfiguration implements Serializable {
    ...
    /**
     * @deprecated since 4.13 Do not use this method, instead use the provided type-safe modification methods provided
     *             in this class.
     */
    @Deprecated
     ...
     *
     * @deprecated since 4.13 use the {@link #getBundleDestinationSpecifications()} in preference to this legacy method
     */
    @Deprecated
    ...
    /**
     * An abstract super class of all types of bundle destinations.
     *
     * @since 4.13
     */
