...
public class ResourceMeasurementScheduleRequest implements Serializable {
    ...
    /**
     * Returns the number of schedules that were created as part of the request.
     * This doesn't tell you which {@link #getMeasurementSchedules() schedules} were created,
     * but it does tell you how many were created. If this returns 0, all the schedules in
     * this object were pre-existing.
     * 
     * @return the number of schedules that are new, having been just created 
     */
    public int getCreatedCount() {
        return this.created;
    }

    public void setCreatedCount(int created) {
