...
/**
 * Convienence utility that creates I18N {@link Logger loggers} and {@link Msg messages} for the agent. These factory
 * methods are used to create I18N objects that access the propery resource bundle for the agent module.
 *
 * @author John Mazzitelli
 */
public class AgentI18NFactory {
    private static final Msg.BundleBaseName s_bundleBaseName = new Msg.BundleBaseName("agent-messages");
    ...
    /**
     * Creates a {@link Msg} that uses the agent's messages resource bundle and the VM's default locale.
     *
    ...
    /**
     * Creates a {@link Msg} that uses the agent's message resource bundle and {@link LoggerLocale}, which is used by
