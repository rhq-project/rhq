...
public interface AgentI18NResourceKeys {
    ...
    @I18NMessage("Asks a plugin to run a server scan discovery. This is a way to determine\\n\\\n"
        ...
        + "for parent servers already in inventory) unless you use --full.\\n\\\n"
        + "The valid command line arguments are:\\n\\\n"
        + "\\  -f, --full : Runs a detailed discovery inside the plugin container. This\\n\\\n"
        + "\\               This will updated the actual agent inventory;\\n\\\n"
        + "\\               the results are not output.\\n\\\n"
