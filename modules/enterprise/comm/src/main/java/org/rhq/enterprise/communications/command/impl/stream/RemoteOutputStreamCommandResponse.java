...
public class RemoteOutputStreamCommandResponse extends AbstractCommandResponse {
    ...
    /**
     * Constructor for {@link RemoteOutputStreamCommandResponse} that defines a successfully invoked remote stream
     * method.
     *
     * @param cmd     the command that was executed (may be <code>null</code>)
     * @param results the results of the InputStream method call
     */
    public RemoteOutputStreamCommandResponse(Command cmd, Object results) {
        super(cmd, true, results, null);
    }

    /**
     * Constructor for {@link RemoteOutputStreamCommandResponse} that defines a failed remote stream invocation.
     *
     * @param cmd       the command that was executed (may be <code>null</code>)
     * @param exception the exception that describes the failure, if available (may be <code>null</code>)
     */
    public RemoteOutputStreamCommandResponse(Command cmd, Throwable exception) {
        super(cmd, false, null, exception);
    }

    /**
     * Constructor for {@link RemoteOutputStreamCommandResponse}.
     *
