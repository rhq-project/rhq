...
/**
 * Convienence utility that creates I18N {@link Logger loggers} and {@link Msg messages} for the communcations module.
 * These factory methods are used to create I18N objects that access the propery resource bundle for the communications
 * module.
 *
...
public class CommI18NFactory {
    ...
    /**
     * Creates a {@link Msg} that uses the communications module's resource bundle and {@link LoggerLocale}, which is
     * used by the {@link #getLogger(Class) loggers created by this class}. This is useful if you want to set messages
