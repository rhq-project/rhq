...
public interface ILimitedConcurrencyPojo {
    String unlimitedMethod(String str);

    @LimitedConcurrency("limited")
    String limitedMethod(String str);

    @LimitedConcurrency("limitedTimeout")
    @Timeout(1000)
    String limitedWithTimeoutMethod(String str);
