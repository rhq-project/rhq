...
public class LiveGraphD3View extends EnhancedVLayout {
    ...
    public LiveGraphD3View(int resourceId, MeasurementDefinition def) {
        super();
    ...
    private void drawGraph() {
        ...
        HTMLFlow graph = new HTMLFlow("<div id=\"liveChart-" + getChartId()
            + "\" ><svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" style=\"height:100%;\"></svg></div>");
        graph.setWidth100();
        graph.setHeight100();
        addMember(graph);
        loadData();
