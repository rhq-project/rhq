package org.rhq.enterprise.gui.coregui.client.monitor.alert;
...
public class RecentAlertsView extends SubsystemResourceAlertView {

    public RecentAlertsView(String locatorId, boolean hasWriteAccess) {
