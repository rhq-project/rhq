package org.rhq.enterprise.gui.coregui.client.monitor.historic;
...
public class ConfigurationHistoryListView extends ResourceConfigurationHistoryListView {


    public ConfigurationHistoryListView(String locatorId, boolean hasWritePerm) {
