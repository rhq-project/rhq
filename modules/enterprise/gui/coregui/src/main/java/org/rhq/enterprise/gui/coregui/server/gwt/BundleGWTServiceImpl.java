...
public class BundleGWTServiceImpl extends AbstractGWTServiceImpl implements BundleGWTService {
    ...
    */
    ...
    public PageList<BundleResourceDeployment> findBundleResourceDeploymentsByCriteria(BundleResourceDeploymentCriteria criteria) {
        return SerialUtility.prepare(bundleManager.findBundleResourceDeploymentsByCriteria(getSessionSubject(), criteria),
                "BundleService.findBundleResourceDeploymentsByCriteria");
