...
public class GroupDefinitionExpressionBuilderGWTServiceImpl extends AbstractGWTServiceImpl implements
    ...
    @Override
    public ArrayList<String> getPluginConfigurationPropertyNames(int resourceTypeId) throws RuntimeException {
        try {
    ...
    @Override
    public ArrayList<String> getResourceConfigurationPropertyNames(int resourceTypeId) throws RuntimeException {
        try {
    ...
    @Override
    public ArrayList<String> getTraitPropertyNames(int resourceTypeId) throws RuntimeException {
        try {
