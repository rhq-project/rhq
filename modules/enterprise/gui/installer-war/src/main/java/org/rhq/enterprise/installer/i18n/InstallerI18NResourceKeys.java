...
public interface InstallerI18NResourceKeys {
    ...
    @I18NMessage("#ConfiguringtheRHQServer-DatabaseType")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-DatabaseConnectionURL")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-DatabaseJDBCDriverClass")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-DatabaseUserName")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-DatabasePassword")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-ServerBindAddress")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-HTTPPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-SecureHTTPSPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-WebServicePort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-NamingServicePort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-NamingServiceRMIPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-JRMPInvokerRMIPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-PooledInvokerRMIPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-AJPPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-UnifiedInvokerPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingAgentCommunicationsTransport")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingAgentCommunicationsBindAddress")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingAgentCommunicationsPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingAgentCommunicationsTransportParameters")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-AgentMulticastDetectorEnabled")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-AgentMulticastDetectorBindAddress")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-AgentMulticastDetectorMulticastAddress")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-AgentMulticastDetectorPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingSecureSocketProtocol")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingKeystoreFile")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingKeystoreAlgorithm")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingKeystoreType")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingKeystorePassword")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingKeystoreKeyPassword")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingKeystoreAlias")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingTruststoreFile")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingTruststoreAlgorithm")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingTruststoreType")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingTruststorePassword")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-IncomingClientAuthenticationMode")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingSecureSocketProtocol")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingKeystoreFile")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingKeystoreAlgorithm")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingKeystoreType")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingKeystorePassword")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingKeystoreKeyPassword")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingKeystoreAlias")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingTruststoreFile")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingTruststoreAlgorithm")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingTruststoreType")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OutgoingTruststorePassword")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-EmailSMTPPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-EmailFromAddress")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-OperationInvocationDefaultTimeout")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-PartitionName")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-PartitionBindAddress")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-PartitionUDPMulticastGroupIPAddress")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-PartitionUDPMulticastPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-PartitionUDPEJB3EntityCacheMulticastPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-PartitionUDPAlertCacheMulticastPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-PartitionUDPLoopback")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-HAJNDIPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-HAJNDIRMIPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-HAJNDIAutoDiscoveryGroupPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-HAJRMPInvokerRMIPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-HAPooledInvokerPort")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-JGroupsUDPIPTimeToLive")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-WebConnections")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-GlobalConcurrencyLimit")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-InventoryReport")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-AvailabilityReport")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-InventorySynchronization")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-ContentReport")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-ContentDownload")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-MeasurementReport")
    ...
    @I18NMessage("#ConfiguringtheRHQServer-MeasurementScheduleRequest")
