...
public interface InstallerI18NResourceKeys {
    ...
    @I18NMessages( { @I18NMessage(locale = "en", value = "Create a database/user if needed"),
        @I18NMessage(locale = "de", value = "DB mit -benutzer anlegen, falls n�tig") })
    ...
    @I18NMessages( { @I18NMessage(locale = "en", value = "Confirm if these settings are valid"),
        @I18NMessage(locale = "de", value = "�berpr�fen Sie, dass die Einstellungen g�ltig sind") })
    ...
    @I18NMessages( { @I18NMessage(locale = "en", value = "A database schema already exists. What do you want to do?"),
        @I18NMessage(locale = "de", value = "Das gew�nschte Datenbankschema existiert schon. Was wollen Sie machen?") })
    ...
    @I18NMessages( { @I18NMessage(locale = "en", value = "Overwrite it (and lose existing data)"),
        @I18NMessage(locale = "de", value = "�berschreiben (vorhandene Daten gehen verloren)") })
    ...
    @I18NMessages( { @I18NMessage(locale = "en", value = "Keep and, if necessary, upgrade it"),
        @I18NMessage(locale = "de", value = "Behalten und falls n�tig aktualisieren.") })
    ...
    @I18NMessages( { @I18NMessage(locale = "en", value = "The {0} property value was an invalid number [{1}]"),
        @I18NMessage(locale = "de", value = "[{1}] ist ein ung�ltiger Zahlenwert f�r die Eigenschaft {0}") })
    ...
    @I18NMessages( {
        ...
        @I18NMessage(locale = "de", value = "Eine Verbindung zur Datenbank ist mit den gebenen Einstellungen f�r die Datenbank nicht m�glich. \\n\\\n"
            + "Bitte �berpr�fen Sie die Einstellungen und stellen Sie sicher, dass die Datenbak aktiv ist") })
    ...
    @I18NMessages( {
        ...
        @I18NMessage(locale = "de", value = "Diese Seite zeigt Ihnen die aktuellen Konfigurationseinstellungen \\n\\\n"
            + "f�r die Installation des ${product.shortName} Servers. Sie k�nnen keinen, einige oder alle\\n\\\n"
            + "dieser Werte nach Ihren Anforderungen �ndern. Bitte beachten sie, dass \\n\\\n"
            + "einige dieser �nderungen erst nach einem Neustart des Servers aktiv werden. \\n\\\n"
            + "Wenn Sie diese Einstellungen �ndern, m�ssen Sie den Server sofort neu starten, damit \\n\\\n"
    ...
    @I18NMessages( {
        ...
        @I18NMessage(locale = "de", value = "Willkommen beim Installationsprogramm von ${product.shortName}. Mit diesem k�nnen Sie \\n\\\n"
            + "die Installation und Konfiguration von ${product.shortName} komplettieren. \\n\\\n"
            + "Nachdem dies geschehen ist, k�nnen Sie sich einloggen und mit ${product.shortName} arbeiten") })
    ...
    @I18NMessages( { @I18NMessage(locale = "en", value = "Back to configuration page"),
        @I18NMessage(locale = "de", value = "Zur�ck zur Seite mit den Einstellungen") })
    ...
    @I18NMessages( {
        ...
        @I18NMessage(locale = "de", value = "Die unten aufgef�hrten Links enthalten weitere Informationen zu RHQ:") })
    ...
    @I18NMessages( { @I18NMessage(locale = "en", value = "Frequently Asked Questions"),
        @I18NMessage(locale = "de", value = "H�ufig gestellte Fragen") })
