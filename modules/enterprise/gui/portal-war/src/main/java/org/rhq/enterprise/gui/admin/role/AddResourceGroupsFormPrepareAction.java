...
public class AddResourceGroupsFormPrepareAction extends TilesAction {
    public ActionForward execute(ComponentContext context, ActionMapping mapping, ActionForm form,
        ...
        PageList<ResourceGroup> pendingGroups = groupManager.getResourceGroupByIds(whoami, pendingGroupIds, pcp);
        ...
        PageList<ResourceGroup> availableGroups = groupManager.getAvailableResourceGroupsForRole(whoami, roleId,
            pendingGroupIds, pca);
