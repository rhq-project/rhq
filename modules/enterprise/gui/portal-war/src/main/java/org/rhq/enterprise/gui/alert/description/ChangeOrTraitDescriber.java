...
/**
 * Describes <code>CHANGE </code> and <code>TRAIT</code> {@link AlertCondition}s.
 *
 * @author Justin Harris
 */
public class ChangeOrTraitDescriber extends AlertConditionDescriber {

    @Override
    public AlertConditionCategory[] getDescribedCategories() {
        return makeCategories(AlertConditionCategory.CHANGE, AlertConditionCategory.TRAIT);
    }
