...
public class ListInProgressContentRequestsUIBean extends PagedDataTableUIBean {
    ...
    public ListInProgressContentRequestsUIBean() {
    }
    ...
    public DataModel getDataModel() {
        if (dataModel == null) {
            dataModel = new ListContentRequestsDataModel(PageControlView.ContentInProgressRequestsList,
                "ListInProgressContentRequestsUIBean");
        }
    ...
    private class ListContentRequestsDataModel extends PagedListDataModel<ContentServiceRequest> {
        ...
        public PageList<ContentServiceRequest> fetchPage(PageControl pc) {
            ...
            PageList<ContentServiceRequest> pageList = manager.getContentRequestsWithStatus(subject, requestResource
