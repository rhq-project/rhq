...
public class ResourceTreeModelUIBean {
    ...
    private void loadTree() {
        ...
        Resource res = resourceManager.getResourceById(EnterpriseFacesContextUtility.getSubject(), 500050);

        rootNode = new ResourceTreeNode(res);

        List<AutoGroupComposite> children = resourceManager.getChildrenAutoGroups(EnterpriseFacesContextUtility.getSubject(), 500050);
