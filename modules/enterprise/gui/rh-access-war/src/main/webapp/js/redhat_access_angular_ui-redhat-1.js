...
angular.module("cases/views/listFilter.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("cases/views/listFilter.html",
    "<div class=\"row\"><div class=\"col-md-6\"><div rha-searchbox=\"\" placeholder=\"'Search'|translate\"></div></div><div class=\"col-md-3\"><div><span popover=\"{{'Filtering by case groups helps you find related cases.'|translate}}\" tabindex=\"0\" popover-append-to-body=\"true\" popover-trigger=\"mouseenter\" class=\"glyphicon glyphicon-question-sign pull-right\"></span><div rha-groupselect=\"\" ng-init=\"setSearchOptions(true)\"></div></div></div><div class=\"col-md-3\"><div rha-statusselect=\"\"></div></div></div>");
}]);
