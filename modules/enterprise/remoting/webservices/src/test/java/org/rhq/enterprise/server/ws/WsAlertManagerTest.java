 ...
 */
@Test(groups = "ws")
public class WsAlertManagerTest extends AssertJUnit {
    ...
    void testFindAlertDefinitionsWithFilteringAndSortingAndFetchingAssociations() {
        ...
        AlertDefinition alertDefRetrieved = WEBSERVICE_REMOTE.getAlertDefinition(subject, alertDef.getId());
        assertEquals("Alert definition ids do not match.", alertDef.getId(), alertDefRetrieved.getId());
        assertEquals("Alert definition desc do not match.", alertDef.getDescription(), alertDefRetrieved
            .getDescription());
