...
//		JaxbConfiguration configRetrieved = WEBSERVICE_REMOTE.getConfiguration(				
...
//		JaxbConfiguration pluginConfig = WEBSERVICE_REMOTE.getPluginConfiguration(
...
//	     Property property = locateProperty(config.getPropertyListOrPropertySimpleOrPropertyMap(), propertyName);
//
