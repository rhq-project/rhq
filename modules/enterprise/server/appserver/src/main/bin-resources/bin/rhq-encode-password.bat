...
rem this script has been deprecated and will be removed in the next release

echo WARNING! rhq-encode-password.bat has been deprecated. Please use rhq-encode-value.bat utility.
echo.
