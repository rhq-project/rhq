...
#
#    RHQ_CCM_JAVA_OPTS - Java VM command line options to be
...
#                        RHQ_CCM_ADDITIONAL_JAVA_OPTS instead.
#
#    RHQ_CCM_ADDITIONAL_JAVA_OPTS - additional Java VM command
#                                   line options to be passed into the VM.
#                                   This is added to RHQ_CCM_JAVA_OPTS; it
...
if [ -z "$RHQ_CCM_JAVA_OPTS" ]; then
   RHQ_CCM_JAVA_OPTS="-Xms512M -Xmx512M -XX:PermSize=128M -XX:MaxPermSize=128M -Djava.net.preferIPv4Stack=true -Dorg.jboss.resolver.warning=true"
fi
...
debug_msg "RHQ_CCM_JAVA_OPTS: $RHQ_CCM_JAVA_OPTS"
debug_msg "RHQ_CCM_ADDITIONAL_JAVA_OPTS: $RHQ_CCM_ADDITIONAL_JAVA_OPTS"
