 ...
 * @author John Sanda
 */
public class MetricsServerPluginService extends ServerPluginService implements MetricsServerPluginServiceMBean {

    public TestMasterServerPluginContainer master;
    public MasterServerPluginContainerConfiguration masterConfig;

    public MetricsServerPluginService() {
    ...
    class TestMetricsServerPluginContainer extends MetricsServerPluginContainer {
        public TestMetricsServerPluginContainer(MasterServerPluginContainer master) {
            super(master);
        }

        @Override
        protected ServerPluginManager createPluginManager() {
            return new TestMetricsServerPluginManager(this);
        }
    }

    class TestMetricsServerPluginManager extends MetricsServerPluginManager {
        public TestMetricsServerPluginManager(MetricsServerPluginContainer pc) {
            super(pc);
        }
