...
public class NamingHack {
    ...
    public static void bruteForceInitialContextFactoryBuilder() {
        LOG.info("Hacking the naming subsystem to enable secure execution of scripts inside the server...");
        ...
        synchronized (NamingManager.class) {
            ...
            if (NamingManager.hasInitialContextFactoryBuilder()) {
                ...
                //but as of now, we have no other option but to do this and wait for JBAS-XXX to be resolved and
                //incorporated into our underlying container
