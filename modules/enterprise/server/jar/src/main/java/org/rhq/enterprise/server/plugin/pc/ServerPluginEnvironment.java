 ...
 */
// this was an almost direct copy of the agent plugin container's PluginEnvironment at one time
public class ServerPluginEnvironment {
    private static final Log log = LogFactory.getLog(ServerPluginEnvironment.class);
    ...
    private void initializeDescriptor(ClassLoader classloader, String descriptorPath, URL pluginJarUrl)
        ...
        try {
            ...
            this.pluginDescriptor = (ServerPluginDescriptor) unmarshaller.unmarshal(jis);
