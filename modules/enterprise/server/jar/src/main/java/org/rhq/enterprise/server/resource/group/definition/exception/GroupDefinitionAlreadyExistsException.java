...
public class GroupDefinitionAlreadyExistsException extends GroupDefinitionException {
    ...
    public GroupDefinitionAlreadyExistsException(String message) {
        super(message);
    }

    public GroupDefinitionAlreadyExistsException(Throwable cause) {
        super(cause);
    }

    public GroupDefinitionAlreadyExistsException(String message, Throwable cause) {
        super(message, cause);
    }
}