...
public class RestReportingBean extends AbstractRestBean implements RestReportingLocal {
    ...
    @EJB
    MeasurementOOBManagerLocal measurementOOBMManager;
    ...
    public Response suspectMetricReport(@Context UriInfo uriInfo, @Context Request request, @Context HttpHeaders headers) {
        ...
        PageList<MeasurementOOBComposite> comps =  measurementOOBMManager.getSchedulesWithOOBs(subjectManager.getOverlord(),null, null,null, pageControl );
        ...
        if (mediaType.equals(MediaType.APPLICATION_XML_TYPE)) {
            ...
            if(!comps.isEmpty()){
                ...
                //empty
                sb.append("No Data Available"); //@todo: 118n
            }
            builder = Response.ok(sb.toString(), mediaType);
