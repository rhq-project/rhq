...
/**
 * The interface to the SLSB Scheduler. This is effectively the same interface as the Scheduler MBean Service with some
 * additional convienence methods.
 *
 * @author John Mazzitelli
 */
@Local
public interface SchedulerLocal extends SchedulerServiceMBean {
    /**
