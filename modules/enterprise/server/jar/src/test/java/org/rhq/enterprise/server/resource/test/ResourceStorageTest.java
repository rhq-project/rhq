...
public class ResourceStorageTest extends AbstractEJB3Test {
    ...
    public void testMixedGroupCompositeQuery() throws Exception {
        ...
        try {
            ...
            Subject subject = subjectManager.getOverlord();
            createSession(subject);
            List<ResourceGroupComposite> groups = groupManager.getAllResourceGroups(subject, GroupCategory.MIXED, null,
                null, null, pc);
    ...
    public void testCompatibleGroupCompositeQuery() throws Exception {
        ...
        try {
            ...
            SubjectManagerLocal subjectManager = LookupUtil.getSubjectManager();
            PageControl pc = new PageControl(1, 5, new OrderingField("g.name", PageOrdering.ASC));
            PageList<ResourceGroupComposite> groups = groupManager.getAllResourceGroups(subjectManager.getOverlord(),
                GroupCategory.COMPATIBLE, null, null, null, pc);
