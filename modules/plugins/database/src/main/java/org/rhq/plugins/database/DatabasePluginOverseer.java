...
/**
 * This is an overseer object for database plugins. It is used to
 ...
 */
public class DatabasePluginOverseer implements PluginOverseer {

    private final Log log = LogFactory.getLog(DatabasePluginOverseer.class);
