 ...
 * @author Lukas Krejci
 */
@Test(groups = {"as5-plugin", "as5-plugin-ejb3", "as5-plugin-ejb3-sfsb" })
public class Ejb3SFSBResourceTest extends AbstractEjb3SessionBeanResourceTest {
