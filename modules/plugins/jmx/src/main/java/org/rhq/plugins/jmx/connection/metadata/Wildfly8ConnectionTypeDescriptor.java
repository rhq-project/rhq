 ...
 */
public class Wildfly8ConnectionTypeDescriptor extends JSR160ConnectionTypeDescriptor {
    @Override
    ...
    public String getDisplayName() {
        return "Wildfly 8 connection type";
    }

    @Override
    public String getDefaultServerUrl() {
        return "service:jmx:http-remoting-jmx://localhost:8080";
    }
