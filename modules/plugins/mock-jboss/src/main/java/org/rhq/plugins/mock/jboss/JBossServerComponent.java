 ...
 * Author: Jason Dobies
 */
public class JBossServerComponent
   implements ResourceComponent, ConfigurationFacet, DeleteResourceFacet, CreateChildResourceFacet
{
      ...
      switch (resourceType.getCreationDataType())
      {
         case CONFIGURATION:
            if (isJndiKeyedResource(resourceType))
            {
               ...
               DiscoveredResourceDetails resource = new DiscoveredResourceDetails(resourceType, jndiName, jndiName, null, null, null, null);
         ...
         case CONTENT:
            ...
            DiscoveredResourceDetails resource = new DiscoveredResourceDetails(resourceType, resourceKey, resourceName, null, null, null, null);
            Map<String, DiscoveredResourceDetails> resourceMap = ResourceCache.getResourceMap(resourceType, this);
