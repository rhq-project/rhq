...
package org.jboss.on.plugins.mock.jboss.metrics.test;
...
public class MetricValueCalculatorTest
{
   ...
   private static MeasurementScheduleRequest TEST_REQUEST = new MeasurementScheduleRequest(0, "test", 0, true, DataType.MEASUREMENT);
