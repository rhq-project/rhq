...
/**
 * This class implements an Exception that is thrown if a service is requested that does not exist
 *
 * @author Alexander Kiefer
 */
public class InvalidServiceRequestException extends NagiosException
{
	/**
	 * Default Constructor is private because it should not be used
	 */
	@SuppressWarnings("unused")
	private InvalidServiceRequestException()
	{
	...
	{
		super("REQUESTED SERVICE <" + serviceName + "> DOES NOT EXIST");
	}
}
