 ...
 * @author Heiko W. Rupp
 */
public class FeedComponent implements ResourceComponent<TwitComponent>, MeasurementFacet, DeleteResourceFacet
{
   private final Log log = LogFactory.getLog(this.getClass());

   private static final long NOT_YET_SET = 1;

   public static final String TOPIC_EVENT = "TopicEvent"; // Same as in Plugin-Descriptor
   ...
   /**
     ...
     */
    public void start(ResourceContext<TwitComponent> context) throws InvalidPluginConfigurationException, Exception {
        ...
        eventPoller = new TwitStatEventPoller(TOPIC_EVENT);
