...
public class ManagedServerTest extends AbstractJBossAS7PluginTest {
    ...
    public static final ResourceType RESOURCE_TYPE = new ResourceType("Managed Server", Constants.PLUGIN_NAME,
    ...
    public void initialDiscoveryTest() throws Exception {
        ...
        Resource serverResource = waitForResourceByTypeAndKey(platform, platform, Constants.DOMAIN_RESOURCE_TYPE,
