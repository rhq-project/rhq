...
import static org.rhq.modules.plugins.wildfly10.ModuleOptionsComponent.createAddModuleOptionTypeOperation;
import static org.rhq.modules.plugins.wildfly10.ModuleOptionsComponent.loadModuleOptionType;
import static org.rhq.modules.plugins.wildfly10.ModuleOptionsComponent.populateSecurityDomainModuleOptions;
...
public class SecurityModuleOptionsTest extends AbstractJBossAS7PluginTest {
    ...
    private static final ResourceType RESOURCE_TYPE = new ResourceType(SECURITY_RESOURCE_TYPE, Constants.PLUGIN_NAME,
    ...
    private Resource getResource() {
        ...
        Resource server = waitForResourceByTypeAndKey(platform, platform, Constants.STANDALONE_RESOURCE_TYPE,
    ...
    private Resource getModuleOptionTypeResource(String optionAttributeType) {
        ...
        if (testSecurityDomain == null) {
            ...
            //host controller
            Resource hostController = waitForResourceByTypeAndKey(platform, platform, Constants.DOMAIN_RESOURCE_TYPE,
                Constants.DOMAIN_RESOURCE_KEY);
            if (hostController != null)
                System.out.println("*** Found Host Controller [" + hostController.getResourceKey() + "]");

            //profile=full-ha
            ResourceType profileType = new ResourceType("Profile", Constants.PLUGIN_NAME, ResourceCategory.SERVICE, null);
            String key = PROFILE;
            ...
            //Security (Profile)
            ResourceType securityType = new ResourceType("Security (Profile)", Constants.PLUGIN_NAME, ResourceCategory.SERVICE,
                null);
            ...
            ResourceType domainType = new ResourceType("Security Domain (Profile)", Constants.PLUGIN_NAME,
                ResourceCategory.SERVICE, null);
        ...
        ResourceType moduleOptionType = new ResourceType(descriptorName, Constants.PLUGIN_NAME, ResourceCategory.SERVICE, null);
    ...
    private Resource getModuleOptionsResource(Resource parent, String optionAttributeType) {
        ...
        ResourceType modulesType = new ResourceType(descriptorName, Constants.PLUGIN_NAME, ResourceCategory.SERVICE, null);
        ...
        //Module Options
        ResourceType moduleOptionsType = new ResourceType(moduleOptionsDescriptor, Constants.PLUGIN_NAME,
            ResourceCategory.SERVICE, null);
    ...
    private ResourceType buildResourceType(String pluginTypeName) {
        ...
        if ((pluginTypeName != null) && (!pluginTypeName.isEmpty())) {
            created = new ResourceType(pluginTypeName, Constants.PLUGIN_NAME, ResourceCategory.SERVICE, null);
        }
        return created;
    }
