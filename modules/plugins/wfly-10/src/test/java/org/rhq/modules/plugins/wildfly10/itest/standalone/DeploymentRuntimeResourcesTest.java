...
import static org.rhq.modules.plugins.wildfly10.itest.standalone.DeploymentTest.getMeasurementScheduleRequests;
import static org.rhq.modules.plugins.wildfly10.itest.standalone.DeploymentTest.getMissingMeasurements;
import static org.rhq.modules.plugins.wildfly10.itest.standalone.DeploymentTest.getTestDeploymentPackageDetails;
...
public class DeploymentRuntimeResourcesTest extends AbstractJBossAS7PluginTest {
    ...
    public void testDeploy() throws Exception {
        ...
        Resource standaloneServer = waitForResourceByTypeAndKey(platform, platform, Constants.STANDALONE_RESOURCE_TYPE,
        ...
        deployment = waitForResourceByTypeAndKey(platform, standaloneServer, new ResourceType("Deployment",
            Constants.PLUGIN_NAME, ResourceCategory.SERVICE, null), "deployment=" + packageDetails.getName());
